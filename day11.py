...
# first floor: promethium generator, promethium-compatible microchip.
# second floor: cobalt generator, curium generator,
#     ruthenium generator, and plutonium generator.
# third floor: cobalt-compatible microchip, curium-compatible microchip,
#     ruthenium-compatible microchip, and plutonium-compatible microchip.
# The fourth floor contains nothing relevant.

indices = ['prg', 'prm', 'cog', 'com', 'cug', 'cum', 'rug', 'rum',
           'plg', 'plm', 'elg', 'elm', 'dig', 'dim']
